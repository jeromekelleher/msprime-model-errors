...
At least for the neutral polygenic architectures and continental-scale demographic model
considered here, genetic drift alone does not appear to induce large directional biases
...
\caption{\textbf{The transferability of PRS under neutrality}.
    ...
    the three populations (C, D), and while risk prediction in the African and East Asian population is
