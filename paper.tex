...
\title{Lessons learned from buggy models of human history}
...
\aprcomment{fix this sentence ->} The increase in complexity of possible demographic models also provides additional ways
...
\sgcomment{In the race to build more realistic and useful simulations of genetic diversity, 
scientific software developers often focus on computational speed and biological realism. 
User interface and application programming interfaces (API), however, also determine 
