...
As the complexity of demographic models we study grows, however, there is an ever-increasing
...
Example of model specification for the two softwares is provided in the Methods section. 
...
Implementing multi-population models of demographic history for either software is hard and error-prone. 
...
Even though the error had a limited effect on simulated data, the tutorial code has been 
...
visualization can be automated. msprime does contain a demography debugging tool summarizing 
demographic events occurring over time, and various efforts are underway to facilitate 
the specification and visualization of population genetics models \cite{zhou2018popdemog}, \sgcomment{Mention Aaron's code and Slim?}.
